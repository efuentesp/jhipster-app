...
describe('Service Tests', () => {
    ...
    describe('UserAuthoritySubModulo Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserAuthoritySubModuloService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-authority-sub-modulos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserAuthoritySubModulo', () => {
