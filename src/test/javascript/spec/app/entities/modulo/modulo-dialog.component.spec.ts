...
import { ModuloDialogComponent } from '../../../../../../main/webapp/app/entities/modulo/modulo-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Modulo Management Dialog Component', () => {
        let comp: ModuloDialogComponent;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ModuloDialogComponent],
                providers: [
                    ModuloService
                ]
            })
            .overrideTemplate(ModuloDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'moduloListModification', content: 'OK'});
